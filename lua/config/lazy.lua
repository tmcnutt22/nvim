...
vim.opt.rtp:prepend(lazypath) -- puts lazy in runtime path for neovim
...
vim.keymap.set("n", "<leader>eq", "<Cmd>Neotree close<CR>", { noremap = true, silent = true })
...
vim.keymap.set("n", "<leader>c", "<cmd>bdelete<CR>")                                           -- Pick buffer to close
vim.keymap.set("n", "<leader>bb", "<cmd>BufferLinePick<CR>")                                   -- Pick which buffer to go to
vim.keymap.set("n", "<leader>bc", "<cmd>BufferLineCloseLeft<CR><cmd>BufferLineCloseRight<CR>") -- Close all but current

-- Window navigation with Ctrl + hjkl (like tmux)
...
-- git blame
-- Git blame - show current line blame temporarily
vim.keymap.set("n", "<leader>gl", function()
  -- Open blame in a floating window
